  ...
  return (
    <section className="section" data-scroll-section>
      <div className="row d-flex fluid-container">
        ...
        <div className="col-12 col-lg-6 mt-3 mt-lg-5" data-scroll="" data-scroll-speed="4" data-scroll-delay="1">
          <p>
            I dislike labels, but if I had to define myself, I would say that{" "}
